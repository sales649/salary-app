...
# تطبيق تنسيق RTL الشامل لإجبار كافة العناصر والجداول والنوافذ المنبثقة على المحاذاة لليمين
st.markdown("""
    <style>
...
initial_data = [
    ...
    {'م': 2, 'الاسم': 'فيض الإسلام', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-09-20', 'تاريخ انتهاء العقد': '2026-12-31', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 3, 'الاسم': 'أيوب', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-08-01', 'تاريخ انتهاء العقد': '2026-11-15', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 4, 'الاسم': 'ذاكر حسين', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-10', 'تاريخ انتهاء العقد': '2027-05-20', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 5, 'الاسم': 'رفيق الإسلام', 'الوظيفة': 'عامل', 'الراتب الأساسي': 1600.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-01-10', 'تاريخ انتهاء العقد': '2027-03-01', 'الخصومات': 0.0, 'الدفعة 1': 0.0, 'الدفعة 2': 800.0, 'الدفعة المدفوعة': 800.0, 'المتبقي': 800.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 6, 'الاسم': 'رحيم', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-20', 'تاريخ انتهاء العقد': '2027-02-01', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 7, 'الاسم': 'محي الدين', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-04-15', 'تاريخ انتهاء العقد': '2027-06-01', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 10, 'الاسم': 'عالم روبيل', 'الوظيفة': 'عامل', 'الراتب الأساسي': 500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-05-10', 'تاريخ انتهاء العقد': '2027-07-01', 'الخصومات': 0.0, 'الدفعة 1': 500.0, 'الدفعة 2': 250.0, 'الدفعة المدفوعة': 750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 11, 'الاسم': 'شوقي كامل', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-10-30', 'تاريخ انتهاء العقد': '2027-01-01', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 12, 'الاسم': 'عمرو فوزي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-01', 'تاريخ انتهاء العقد': '2027-05-01', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 13, 'الاسم': 'محمد فوزي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-01', 'تاريخ انتهاء العقد': '2027-05-01', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 14, 'الاسم': 'إبراهيم السيد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-15', 'تاريخ انتهاء العقد': '2027-02-01', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 15, 'الاسم': 'مصطفي عماد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-01-20', 'تاريخ انتهاء العقد': '2027-03-15', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 16, 'الاسم': 'محمد شريف ', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-12-10', 'تاريخ انتهاء العقد': '2027-02-28', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 17, 'الاسم': 'محمد رضا', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-02-15', 'تاريخ انتهاء العقد': '2027-04-30', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 19, 'الاسم': 'محمد ابو صبري ', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-04-01', 'تاريخ انتهاء العقد': '2027-06-15', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 2500.0, 'الدفعة المدفوعة': 5500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 20, 'الاسم': 'سليمان محي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-30', 'تاريخ انتهاء العقد': '2027-02-10', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 21, 'الاسم': 'فهمي محمد ', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-01-05', 'تاريخ انتهاء العقد': '2027-03-20', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2600.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 22, 'الاسم': 'ريحاني', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-09-25', 'تاريخ انتهاء العقد': '2026-12-05', 'الخصومات': 0.0, 'الدفعة 1': 2200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 3300.0, 'المتبقي': -1100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 23, 'الاسم': 'دلال', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-15', 'تاريخ انتهاء العقد': '2027-05-10', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 24, 'الاسم': 'فاربيس', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-12-20', 'تاريخ انتهاء العقد': '2027-02-15', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 25, 'الاسم': 'قدوس', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-02-28', 'تاريخ انتهاء العقد': '2027-04-18', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 26, 'الاسم': 'مد ابراهيم ', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-05-01', 'تاريخ انتهاء العقد': '2027-07-10', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 27, 'الاسم': 'أنيس الرحمن', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-10-10', 'تاريخ انتهاء العقد': '2026-12-25', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 28, 'الاسم': 'حبيب مد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-01-15', 'تاريخ انتهاء العقد': '2027-03-30', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 29, 'الاسم': 'مطاوع', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-05', 'تاريخ انتهاء العقد': '2027-01-20', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 31, 'الاسم': 'بطشا', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-12-05', 'تاريخ انتهاء العقد': '2027-02-12', 'الخصومات': 0.0, 'الدفعة 1': 1200.0, 'الدفعة 2': 1100.0, 'الدفعة المدفوعة': 2300.0, 'المتبقي': -100.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 32, 'الاسم': 'السيد محمود', 'الوظيفة': 'عامل', 'الراتب الأساسي': 500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-04-10', 'تاريخ انتهاء العقد': '2027-06-20', 'الخصومات': 0.0, 'الدفعة 1': 500.0, 'الدفعة 2': 250.0, 'الدفعة المدفوعة': 750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 33, 'الاسم': 'علي إسماعيل', 'الوظيفة': 'معمل', 'الراتب الأساسي': 4500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-10-25', 'تاريخ انتهاء العقد': '2027-01-15', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 2250.0, 'الدفعة المدفوعة': 5250.0, 'المتبقي': -750.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 34, 'الاسم': 'محمد حمدان عثمان', 'الوظيفة': 'مشرف', 'الراتب الأساسي': 4500.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-02-10', 'تاريخ انتهاء العقد': '2027-04-05', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 2250.0, 'الدفعة المدفوعة': 5250.0, 'المتبقي': -750.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 35, 'الاسم': 'عثمان عبدالله', 'الوظيفة': 'مشرف', 'الراتب الأساسي': 7000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-01', 'تاريخ انتهاء العقد': '2027-02-14', 'الخصومات': 0.0, 'الدفعة 1': 4000.0, 'الدفعة 2': 3500.0, 'الدفعة المدفوعة': 7500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 41, 'الاسم': 'محمد سويلم', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-09-05', 'تاريخ انتهاء العقد': '2026-10-10', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 42, 'الاسم': 'عمرو حمودة', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-06-01', 'تاريخ انتهاء العقد': '2027-08-01', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 2500.0, 'الدفعة المدفوعة': 5500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 43, 'الاسم': 'محمود عثمان', 'الوظيفة': 'مشرف', 'الراتب الأساسي': 7000.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-01-10', 'تاريخ انتهاء العقد': '2027-03-15', 'الخصومات': 0.0, 'الدفعة 1': 0.0, 'الدفعة 2': 3500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': 3500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 45, 'الاسم': 'زنجير', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-05', 'تاريخ انتهاء العقد': '2027-05-12', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 2500.0, 'الدفعة المدفوعة': 5500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 46, 'الاسم': 'بابلو', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-12', 'تاريخ انتهاء العقد': '2027-01-25', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 2500.0, 'الدفعة المدفوعة': 5500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 47, 'الاسم': 'إسماعيل الحداد', 'الوظيفة': 'حداد', 'الراتب الأساسي': 6000.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-02-20', 'تاريخ انتهاء العقد': '2027-04-10', 'الخصومات': 0.0, 'الدفعة 1': 3500.0, 'الدفعة 2': 3000.0, 'الدفعة المدفوعة': 6500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 48, 'الاسم': 'نعيم', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-12-15', 'تاريخ انتهاء العقد': '2027-02-20', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 49, 'الاسم': 'مرسي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-04-05', 'تاريخ انتهاء العقد': '2027-06-12', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 50, 'الاسم': 'محمد علي كاشف', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-10-18', 'تاريخ انتهاء العقد': '2026-12-28', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 51, 'الاسم': 'احمد علي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3500.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-01-25', 'تاريخ انتهاء العقد': '2027-03-30', 'الخصومات': 0.0, 'الدفعة 1': 2500.0, 'الدفعة 2': 1750.0, 'الدفعة المدفوعة': 4250.0, 'المتبقي': -750.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 52, 'الاسم': 'عبد الرحمن محمد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500.0, 'الفرع': 'مستودع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-30', 'تاريخ انتهاء العقد': '2027-05-25', 'الخصومات': 0.0, 'الدفعة 1': 1500.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2750.0, 'المتبقي': -250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 36, 'الاسم': 'ابون', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مستودع ميم الخماسية الرياض', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-12-12', 'تاريخ انتهاء العقد': '2027-04-01', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 38, 'الاسم': 'سمان السواق', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3500.0, 'الفرع': 'مستودع ميم الخماسية الرياض', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2026-11-25', 'تاريخ انتهاء العقد': '2027-01-30', 'الخصومات': 0.0, 'الدفعة 1': 3000.0, 'الدفعة 2': 1750.0, 'الدفعة المدفوعة': 4750.0, 'المتبقي': -1250.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 40, 'الاسم': 'إبراهيم جمال', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000.0, 'الفرع': 'مستودع ميم الخماسية الرياض', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-03-15', 'تاريخ انتهاء العقد': '2027-05-18', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 1500.0, 'الدفعة المدفوعة': 3500.0, 'المتبقي': -500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 54, 'الاسم': 'سمير المغازي ', 'الوظيفة': 'كميائي ', 'الراتب الأساسي': 5000.0, 'الفرع': 'مصنع ميم الخماسية الخرج', 'تاريخ بداية العمل': '2024-01-01', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2027-12-31', 'الخصومات': 0.0, 'الدفعة 1': 0.0, 'الدفعة 2': 2500.0, 'الدفعة المدفوعة': 2500.0, 'المتبقي': 2500.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''}
]
    ...
    if selected_option == '🏠 الرئيسية (لوحة الإحصائيات)':
        ...
        for b_name, tab_obj in branches:
            with tab_obj:
                ...
                # ترتيب الأعمدة من اليمين إلى اليسار شاملاً حقل الخصومات المحدث
                cols_rtl = ['م', 'الاسم', 'الوظيفة', 'الراتب الأساسي', 'الخصومات', 'الدفعة 1', 'الدفعة 2', 'نوع الإجراء', 'الملاحظات']
                ...
                s_col2.metric("إجمالي الخصومات", f"{b_tot_ded:,.0f} ر.س")
                s_col3.metric("إجمالي الدفعة الأولى", f"{b_tot_p1:,.0f} ر.س")
                s_col4.metric("إجمالي الدفعة الثانية", f"{b_tot_p2:,.0f} ر.س")
