...
if not st.session_state.app_started:
    ...
    st.markdown("""
        <div class="welcome-card">
            ...
            <div class="subtitle-ar">النظام المحاسبي الإداري الشامل للرواتب والدفعات المالية وسندات القبض</div>
        </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        with st.expander('➕ إضافة شهر جديد'):
            new_m = st.text_input('اسم الشهر الجديد (مثلاً: ديسمبر 2026):')
            if st.button('تأكيد تفعيل الشهر'):
                if new_m and new_m not in st.session_state.months_list:
                    st.session_state.months_list.append(new_m)
                    st.success(f'تم تفعيل شهر {new_m} بنجاح!')
                    st.rerun()

    # قاعدة البيانات لـ 52 موظفاً بالمسميات الصحيحة والمعتمدة
    initial_data = [
        # مصنع ميم الخماسية الخرج (35 موظف)
        {'م': 1, 'الاسم': 'مد ماجد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 4000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 2, 'الاسم': 'فيض الإسلام', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 3, 'الاسم': 'أيوب', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 4, 'الاسم': 'ذاكر حسين', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 5, 'الاسم': 'رفيق الإسلام', 'الوظيفة': 'عامل', 'الراتب الأساسي': 1600, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 6, 'الاسم': 'رحيم', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 7, 'الاسم': 'محي الدين', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 8, 'الاسم': 'محمد ريان', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 9, 'الاسم': 'مدلايس', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 10, 'الاسم': 'عالم روبيل', 'الوظيفة': 'عامل', 'الراتب الأساسي': 500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 11, 'الاسم': 'شوقي كامل', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 12, 'الاسم': 'عمرو فوزي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 13, 'الاسم': 'محمد فوزي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 14, 'الاسم': 'إبراهيم السيد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 15, 'الاسم': 'مصطفي عماد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 16, 'الاسم': 'محمد شريف دتة', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 17, 'الاسم': 'محمد رضا', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 18, 'الاسم': 'أبو نوح', 'الوظيفة': 'عامل', 'الراتب الأساسي': 4000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 19, 'الاسم': 'أبو صبري', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 20, 'الاسم': 'سليمان محي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 21, 'الاسم': 'حمزة داهما', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 22, 'الاسم': 'ريحاني', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 23, 'الاسم': 'دلال', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 24, 'الاسم': 'فاربيس', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 25, 'الاسم': 'قدوس', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 26, 'الاسم': 'مد أبو بكر الصديق', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 27, 'الاسم': 'أنيس الرحمن', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 28, 'الاسم': 'حبيب مد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 29, 'الاسم': 'مطيع الرحمن', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 30, 'الاسم': 'حبيب آل ملايس', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2000, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 31, 'الاسم': 'بطشا', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2200, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 32, 'الاسم': 'السيد محمود', 'الوظيفة': 'عامل', 'الراتب الأساسي': 500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 33, 'الاسم': 'علي إسماعيل', 'الوظيفة': 'معمل', 'الراتب الأساسي': 4500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 34, 'الاسم': 'محمد حمدان عثمان', 'الوظيفة': 'مشرف', 'الراتب الأساسي': 4500, 'الفرع': 'مصنع ميم الخماسية الخرج'},
        {'م': 35, 'الاسم': 'عثمان عبدالله', 'الوظيفة': 'مشرف', 'الراتب الأساسي': 7000, 'الفرع': 'مصنع ميم الخماسية الخرج'},

        # مستودع ميم الخماسية الخرج (12 موظف - الملقة سابقا)
        {'م': 41, 'الاسم': 'محمد سويلم', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 42, 'الاسم': 'عمرو حمودة', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 43, 'الاسم': 'محمود عثمان', 'الوظيفة': 'مشرف', 'الراتب الأساسي': 7000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 44, 'الاسم': 'شمشاد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 4000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 45, 'الاسم': 'زنجير', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 46, 'الاسم': 'بابلو', 'الوظيفة': 'عامل', 'الراتب الأساسي': 5000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 47, 'الاسم': 'إسماعيل الحداد', 'الوظيفة': 'حداد', 'الراتب الأساسي': 6000, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 48, 'الاسم': 'نعيم', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 49, 'الاسم': 'مرسي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 50, 'الاسم': 'محمد علي كاشف', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 51, 'الاسم': 'احمد علي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3500, 'الفرع': 'مستودع ميم الخماسية الخرج'},
        {'م': 52, 'الاسم': 'عبد الرحمن محمد', 'الوظيفة': 'عامل', 'الراتب الأساسي': 2500, 'الفرع': 'مستودع ميم الخماسية الخرج'},

        # مستودع ميم الخماسية الرياض (5 موظفين)
        {'م': 36, 'الاسم': 'ابون', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مستودع ميم الخماسية الرياض'},
        {'م': 37, 'الاسم': 'محمد علي', 'الوظيفة': 'عامل', 'الراتب الأساسي': 0, 'الفرع': 'مستودع ميم الخماسية الرياض'},
        {'م': 38, 'الاسم': 'سمان السواق', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3500, 'الفرع': 'مستودع ميم الخماسية الرياض'},
        {'م': 39, 'الاسم': 'عمر رشدي', 'الوظيفة': 'محاسب', 'الراتب الأساسي': 4000, 'الفرع': 'مستودع ميم الخماسية الرياض'},
        {'م': 40, 'الاسم': 'إبراهيم جمال', 'الوظيفة': 'عامل', 'الراتب الأساسي': 3000, 'الفرع': 'مستودع ميم الخماسية الرياض'},
    ...
    # دالة توليد صفحة A4 لسندات صرف الرواتب بالهيدر واللوجو المعتمد
    ...
    if '📊' in menu:
        ...
        st.write('قم بتعديل مبالغ الدفعات للفروع الرسمية، وسيتحدث السجل ومسير الرواتب والسندات تلقائياً.')
        
        t1, t2, t3, t4 = st.tabs(['📍 مصنع ميم الخماسية الخرج (35)', '📍 مستودع ميم الخماسية الخرج (12)', '📍 مستودع ميم الخماسية الرياض (5)', '📍 رواتب متنوعة'])
        branches = [
            ('مصنع ميم الخماسية الخرج', t1),
            ('مستودع ميم الخماسية الخرج', t2),
            ('مستودع ميم الخماسية الرياض', t3),
            ('رواتب متنوعة', t4)
        ]
        ...
        s1, s2, s3, s4 = st.tabs(['مصنع ميم الخماسية الخرج', 'مستودع ميم الخماسية الخرج', 'مستودع ميم الخماسية الرياض', 'رواتب متنوعة'])
        
        for b_name, tab_obj in [
            ('مصنع ميم الخماسية الخرج', s1),
            ('مستودع ميم الخماسية الخرج', s2),
            ('مستودع ميم الخماسية الرياض', s3),
            ('رواتب متنوعة', s4)
        ]:
            with tab_obj:
        ...
        st.write('كشف مسير الرواتب الموحد لجميع الموظفين بالفروع الرسمية جاهز للطباعة والتحميل.')
