...
st.markdown(f"""
    <style>
        ...
        /* إخفاء وتلوين الشريط الأبيض العلوي تماماً */
        ...
        /* كارت اللوجو واسم الشركة في القائمة الجانبية */
        .sidebar-logo-card {{
...
def load_monthly_payroll_store():
    return fetch_cloud_store('monthly_payroll_store_v2', {})

def save_monthly_payroll_store(store_data):
    save_cloud_store('monthly_payroll_store_v2', store_data)
...
if not st.session_state.get('app_started', False):
    ...
    # 3. القائمة الجانبية الهيكلية المحدثة بتكبير اللوجو واسم الشركة
    with st.sidebar:
        st.markdown("""
