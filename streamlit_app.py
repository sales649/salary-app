...
august_payroll_data = [
    ...
    # 4. الموظفون المتنوعون (إضافة بيانات الإكسيل المرفقة)
    ...
    {'م': 57, 'الاسم': 'حسن أنور عبد الرحمن', 'الوظيفة': 'مدير مشتريات', 'الراتب الأساسي': 4000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-02-09', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2027-02-08', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 2000.0, 'الدفعة المدفوعة': 4000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 59, 'الاسم': 'طارق محمد ابن علي', 'الوظيفة': 'صيدلي', 'الراتب الأساسي': 5500.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-01-19', 'تاريخ انتهاء الإقامة': '13/04/1450', 'تاريخ انتهاء العقد': '18/0/2027', 'الخصومات': 0.0, 'الدفعة 1': 2750.0, 'الدفعة 2': 2750.0, 'الدفعة المدفوعة': 5500.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 60, 'الاسم': 'فاطمة احمد ابن عطية', 'الوظيفة': 'اخصائي إيرادات حكومية', 'الراتب الأساسي': 2000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-01-01', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2026-12-31', 'الخصومات': 0.0, 'الدفعة 1': 1000.0, 'الدفعة 2': 1000.0, 'الدفعة المدفوعة': 2000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 63, 'الاسم': 'محمد محمود عبد المنعم', 'الوظيفة': 'الإنتاج الكميائي', 'الراتب الأساسي': 12000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2025-08-22', 'تاريخ انتهاء الإقامة': '2026-02-04', 'تاريخ انتهاء العقد': '2026-08-21', 'الخصومات': 0.0, 'الدفعة 1': 6000.0, 'الدفعة 2': 6000.0, 'الدفعة المدفوعة': 12000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 64, 'الاسم': 'مد ساجد', 'الوظيفة': 'عامل تحميل وتنزيل', 'الراتب الأساسي': 4000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2025-12-04', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2030-12-03', 'الخصومات': 0.0, 'الدفعة 1': 2000.0, 'الدفعة 2': 2000.0, 'الدفعة المدفوعة': 4000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 65, 'الاسم': 'منيرة سعود عبدالله بن سيف', 'الوظيفة': 'موظف', 'الراتب الأساسي': 2000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-05-20', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2027-05-19', 'الخصومات': 0.0, 'الدفعة 1': 1000.0, 'الدفعة 2': 1000.0, 'الدفعة المدفوعة': 2000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 66, 'الاسم': 'محمد روبيل', 'الوظيفة': 'عامل وضع ملصقات', 'الراتب الأساسي': 1500.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-04-29', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2024-04-28', 'الخصومات': 0.0, 'الدفعة 1': 750.0, 'الدفعة 2': 750.0, 'الدفعة المدفوعة': 1500.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 67, 'الاسم': 'مازن سعد ابن رفيع', 'الوظيفة': 'دكتور صيدلي', 'الراتب الأساسي': 2000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2025-12-28', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2026-12-27', 'الخصومات': 0.0, 'الدفعة 1': 1000.0, 'الدفعة 2': 1000.0, 'الدفعة المدفوعة': 2000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 68, 'الاسم': 'اسامه خالد عبد الرحمن', 'الوظيفة': 'مشرف صيانه', 'الراتب الأساسي': 2000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-01-08', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2027-01-07', 'الخصومات': 0.0, 'الدفعة 1': 1000.0, 'الدفعة 2': 1000.0, 'الدفعة المدفوعة': 2000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    {'م': 69, 'الاسم': 'محمود محمد عثمان احمد', 'الوظيفة': 'عامل تحميل وتنزيل', 'الراتب الأساسي': 2500.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2026-09-03', 'تاريخ انتهاء الإقامة': '2027-12-31', 'تاريخ انتهاء العقد': '2027-03-08', 'الخصومات': 0.0, 'الدفعة 1': 1250.0, 'الدفعة 2': 1250.0, 'الدفعة المدفوعة': 2500.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
    ...
    {'م': 71, 'الاسم': 'سمير المغازي كمال', 'الوظيفة': 'الإنتاج الكميائي', 'الراتب الأساسي': 5000.0, 'الفرع': 'رواتب متنوعة', 'تاريخ بداية العمل': '2025-07-07', 'تاريخ انتهاء الإقامة': '2027-01-25', 'تاريخ انتهاء العقد': '2026-07-06', 'الخصومات': 0.0, 'الدفعة 1': 2500.0, 'الدفعة 2': 2500.0, 'الدفعة المدفوعة': 5000.0, 'المتبقي': 0.0, 'نوع الإجراء': 'صرف كامل', 'الملاحظات': ''},
